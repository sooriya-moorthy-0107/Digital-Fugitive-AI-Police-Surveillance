...
DARK_BLUE = (10, 10, 30)
TRANSPARENT_GREY = (200, 200, 200, 50) 
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
...
class Game:
    ...
    def draw_grid(self):
        s_transparent = pygame.Surface((CELL_SIZE, CELL_SIZE), pygame.SRCALPHA)
        s_transparent.fill(TRANSPARENT_GREY) 
            ...
            for col in range(GRID_SIZE):
                ...
                if cell_value == 0: # Empty
                    ...
                    if self.phase == 1:
                        ...
                        screen.blit(s_transparent, (x, y)) # Hidden in phase 2
